...
-- CHALLENGE QUESTION
SELECT pr2.specialty_description, pr1.specialty_description, total_claim_count
FROM prescriber AS pr1 INNER JOIN prescription USING (npi)
					   INNER JOIN prescriber AS pr2 USING (npi)
GROUP BY pr2.specialty_description,pr1.specialty_description, total_claim_count
